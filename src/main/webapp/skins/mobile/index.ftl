...
<html>
    ...
    <body class="index">
        ...
        <div class="main">
            ...
            <#if ADLabel != ''>
            <div class="item mid">
                <a class="item-header" style="background-image: url(${adBgIcon})" href="//hacpai.com/article/1460083956075">${sponsorLabel}</a>
    ...
    <div class="slogan">
        ${indexIntroLabel}&nbsp;
        <a href="//github.com/b3log/symphony" target="_blank">
            <svg class="ft-gray" height="16" width="16" viewBox="0 0 16 16">${githubIcon}</svg></a>
        <a href="//weibo.com/u/2778228501" target="_blank">
