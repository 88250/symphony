<div class="nav"> 
    <div class="wrapper fn-clear">
        ...
        <div class="fn-right user-nav">
            ...
            <a href="${servePath}/admin" title="${adminLabel}" class="last"><svg class="svg-icon"><use xlink:href="#userrole"></use></svg></a>
            </#if>
            ...
            <a href="${servePath}/activities" title="${activityLabel}"><svg class="svg-icon"><use xlink:href="#flag"></use></svg></a>
            <#if permissions["commonAddArticle"].permissionGrant>
                <a href="${servePath}/pre-post" title="${addArticleLabel}"><svg class="svg-icon"><use xlink:href="#addfile"></use></svg></a>
            </#if>
