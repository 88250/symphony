        ...
        <div class="main">
            <div class="wrapper">
                <div class="content fn-clear">
                    ...
                    <@pagination url="/hot"/>
                    <br>
                    <a href="${servePath}/" class="ft-gray">${moreRecentArticleLabel}</a>
                    <br><br>
                    <div class="module">
