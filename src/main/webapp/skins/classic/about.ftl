        ...
        <div class="main">
            <div class="wrapper fn-clear">
                <div class="content content-reset about">
                    ...
                    <p>
                        博客中的文章评论会同步到社区中，社区帖子的回复同样也会同步到博客的文章中。即加强用户之间的互动行，同时也不失独立博客的自由。
                    </p>
                    <p>
                    ...
                    <p>
                        目前支持部署在 
                        <a href="https://developers.google.com/appengine/">GAE</a>、
                        <a href="http://developer.baidu.com/bae">BAE</a> 或标准 Servlet 容器内，以后将支持更多云平台。
                    </p>
                    <p>
                        平台移植的特性使得用户可以自主选择部署环境，目前来看，GAE 依然是首选，因为它免费、稳定。
                        Solo 也提供了数据导入/导出功能，降低平台迁移成本。如果某个环境计费不爽，搬家就行 ;-)
                    </p>
                    <p>
                        从架构上看，Solo 是 B3log 社区的重要客户端，是提供主要内容的数据来源，其主要包括了文章和评论数据。
                    </p>
                    <br/>
                    <h3>Rhythm</h3>
                    <p>
                    ...
                    <h3>Symphony</h3>
                    <p>
                        这是 B3log 社区项目的代号，也是提供交互聚合的平台。一个最简洁的论坛实现，在这里：  
                    </p>
                    <ul>
                        <li>有人寻求帮助，有人帮助他人</li>
                        <li>有人随便看看，有人云游布道</li>
