        ...
        <li>
            <div class="fn-flex">
                <a rel="nofollow" class="ft-small"
                   ...
                   title="${article.articleAuthorName}"><img class="avatar responsive-hide" src="${article.articleAuthorThumbnailURL}-64.jpg" /></a>
                <div class="fn-flex-1 has-view">
                    <h2>
                        <a rel="nofollow" class="ft-small"
                           href="/member/${article.articleAuthorName}" 
                           title="${article.articleAuthorName}">
                            <img class="avatar-small responsive-show" src="${article.articleAuthorThumbnailURL}-64.jpg" />
                        </a>
            ...
            <div class="commenters">
                ...
                <a rel="nofollow" href="${article.articlePermalink}#${comment.commentId}" title="${comment.articleParticipantName}">
                    <img class="avatar-small" src="${comment.articleParticipantThumbnailURL}-64.jpg" />
                </a>
                </#list>
            </div>
