                    ...
                    <div class="fn-clear article-action">
                        <span class="fn-right">
                            ...
                            <span onclick="Article.toggleToc()" aria-label="${ToCLabel}"
                                  class="tooltipped tooltipped-n ft-a-icon"><span class="icon-unordered-list ft-red"></span></span>
                            </#if>
                            ...
                            <span onclick="Article.revision('${article.oId}')" aria-label="${historyLabel}"
                                  class="tooltipped tooltipped-n ft-a-icon"><span class="icon-refresh"></span></span>
