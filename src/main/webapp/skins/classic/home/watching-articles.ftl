...
<div class="tabs-sub fn-clear">
    <a href="${servePath}/member/${user.userName}/watching/articles"<#if type == "watchingUsers"> class="current"</#if>>${watchingArticlesLabel} &nbsp;<span class="count">${paginationRecordCount}</span></a>
