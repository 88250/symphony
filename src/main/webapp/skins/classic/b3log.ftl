            ...
            <div class="wrapper">
                <div class="content">
                    <div class="module article-module content-reset">
                        <h1 class="article-title"><a class="ft-a-title" href="http://b3log.org" target="_blank">B3log 构思</a></h1>
                        ...
                        <p>
                            从架构上看，Solo 是 B3log 社区的重要客户端，但除了 Solo 外，目前也以插件的方支持了一些主流博客系统，请看<a href="https://hacpai.com/article/1457158841475">这里</a>。
                        </p>
                        <br/>
                        <h3>Rhythm</h3>
                        <p>
