...
!function(e){e.fn.extend({dialog:{version:"0.0.1.7",author:"lly219@gmail.com"}});var t=(new Date).getTime(),i="dialog",n=function(){this._defaults={styleClass:{background:"dialog-background",panel:"dialog-panel",main:"dialog-main",footer:"dialog-footer",headerMiddle:"dialog-header-middle",headerBg:"dialog-header-bg",closeIcon:"icon-close",closeIconHover:"dialog-close-icon-hover",title:"dialog-title"}}};e.extend(n.prototype,{_attach:function(t,n){t.id||(this.uuid++,t.id="dp"+this.uuid);var o=this._newInst(e(t));o.settings=e.extend({},n||{}),e.data(t,i,o),this._init(t)},_newInst:function(e){var t=e[0].id.replace(/([^A-Za-z0-9_])/g,"\\\\$1");return{id:t}},_getInst:function(t){try{return e.data(t,i)}catch(n){throw"Missing instance data for this dialog"}},_destroyDialog:function(t){var n=e.dialog._getInst(t),o=n.id;e.removeData(t,i),e(t).prependTo("#"+o+"Wrap").unwrap(),e(t).removeAttr("style");var a=this._getDefaults(e.dialog._defaults,n.settings,"styleClass");e("."+a.background).remove(),e("#"+o+"Dialog").remove()},_init:function(t){var i=this._getInst(t),n=i.id,o=i.settings,a=e(window).height(),l=e(window).width(),s=this._getDefaults(e.dialog._defaults,o,"styleClass"),d=o.height?o.height:parseInt(.6*a),r=o.width?o.width:parseInt(.6*l);o.title=o.title?o.title:"",o.okText=o.okText?o.okText:"Ok",o.cancelText=o.cancelText?o.cancelText:"Cancel";var c="",u="<div class='fn-clear "+s.headerBg+"'><div class='"+s.title+"'>"+o.title+"</div><a href='javascript:void(0);' class='"+s.closeIcon+"'></a></div>";o.hideFooter||(c="<a href='javascript:void(0);'>"+o.okText+"</a><a href='javascript:void(0);'>"+o.cancelText+"</a>");var h="<div id='"+n+"Dialog' class='"+s.panel+"' style='width: "+r+"px; height: "+d+"px;' onselectstart='return false;'>"+u+"<div class='"+s.main+"' style='overflow: auto;height:"+(d-78)+"px'><div class='"+s.footer+"'>"+c+"</div></div>",g="";if(o.modal&&0===e("."+s.background).length){var p=a<document.documentElement.scrollHeight?document.documentElement.scrollHeight:a;g="<div style='height:"+p+"px;' class='"+s.background+"'></div>"}e("#"+n).wrap("<div id='"+n+"Wrap'></div>");var f=e(t).clone(!0);e(t).remove(),e("body").append(g+h),e(e("#"+n+"Dialog ."+s.main+" div").get(0)).append(f),e(f).show();var v="",m="",_=e("#"+n+"Dialog");o.position?(v=o.position.top,m=o.position.left):(v=parseInt((a-d)/2),m=parseInt((l-r)/2)),_.css({top:v+"px",left:m+"px"}),e("#"+n+"Dialog ."+s.closeIcon).bind("click",function(){e.dialog._close(n,o)});var y=e("#"+n+"Dialog ."+s.footer+" a");e(y.get(1)).bind("click",function(){e.dialog._close(n,o)}),e(y.get(0)).bind("click",function(){(void 0===o.ok||o.ok())&&e.dialog._close(n,o)}),this._bindMove(n,s.headerBg,d,r),e(window).keyup(function(t){27===t.keyCode&&e.dialog._close(n,o)})},_bindMove:function(t,i){e("#"+t+"Dialog ."+i).mousedown(function(i){var n=document;i||(i=window.event);var o=document.getElementById(t+"Dialog"),a=i.clientX-parseInt(o.style.left),l=i.clientY-parseInt(o.style.top);n.ondragstart="return false;",n.onselectstart="return false;",n.onselect="document.selection.empty();",this.setCapture?this.setCapture():window.captureEvents&&window.captureEvents(Event.MOUSEMOVE|Event.MOUSEUP),n.onmousemove=function(t){t||(t=window.event);var i=t.clientX-a,n=t.clientY-l;0>i&&(i=0),i>e(window).width()-e(o).width()&&(i=e(window).width()-e(o).width()),0>n&&(n=0),n>e(window).height()-e(o).height()&&(n=e(window).height()-e(o).height()),o.style.left=i+"px",o.style.top=n+"px"},n.onmouseup=function(){this.releaseCapture?this.releaseCapture():window.captureEvents&&window.captureEvents(Event.MOUSEMOVE|Event.MOUSEUP),n.onmousemove=null,n.onmouseup=null,n.ondragstart=null,n.onselectstart=null,n.onselect=null}})},_close:function(t,i){if("none"!==e("#"+t+"Dialog").css("display")&&(void 0===i.close||i.close())&&(e("#"+t+"Dialog").hide(),i.modal)){var n=this._getDefaults(e.dialog._defaults,i,"styleClass");e("."+n.background).hide()}},_closeDialog:function(t){var i=this._getInst(t),n=i.id,o=i.settings;e.dialog._close(n,o)},_openDialog:function(t){var i=this._getInst(t),n=i.id,o=i.settings;if(e("#"+n+"Dialog").show(),o.modal){var a=this._getDefaults(e.dialog._defaults,o,"styleClass");e("."+a.background).show()}},_updateDialog:function(t,i){var n=this._getInst(t),o=n.id,a=n.settings,l=this._getDefaults(e.dialog._defaults,a,"styleClass");e.extend(a,i);var s=e("#"+o+"Dialog");i.position&&s.css({top:i.position.top,left:i.position.left}),i.width&&(s.width(i.width+26),s.find("."+l.main+" div")[0].style.width=i.width+"px",s.find("."+l.headerBg).width(i.width+18)),i.height&&(s.find("."+l.main+" div")[0].style.height=i.height+"px"),i.title&&s.find("."+l.title).html(i.title),void 0!==i.modal&&(i.modal?e("."+l.background).show():e("."+l.background).hide()),void 0!==i.hideFooter&&(i.hideFooter?s.find("."+l.footer).hide():s.find("."+l.footer).show())},_getDefaults:function(e,t,i){if("styleClass"===i){if("default"===t.theme||void 0===t.theme)return e.styleClass;t.styleClass={};for(var n in e[i])t.styleClass[n]=t.theme+"-"+e.styleClass[n]}else{if("height"===i||"width"===i)return null===t[i]||void 0===t[i]?"auto":t[i]+"px";if(null===t[i]||void 0===t[i])return e[i]}return t[i]}}),e.fn.dialog=function(t){var i=Array.prototype.slice.call(arguments);return"string"==typeof t?(i.shift(),e.dialog["_"+t+"Dialog"].apply(e.dialog,[this[0]].concat(i))):this.each(function(){e.dialog._attach(this,t)})},e.dialog=new n,window["DP_jQuery_"+t]=e}(jQuery),!function(e){var t=(new Date).getTime(),i="completed",n=function(){this._defaults={styleClass:{panelClass:"completed-panel",inputClass:"completed-input",ckClass:"completed-ck"},separator:","},this._settingsDataFormat={}};e.extend(n.prototype,{_attach:function(t,n){t.id||(this.uuid++,t.id="dp"+this.uuid);var o=this._newInst(e(t));o.settings=e.extend({buttonText:"选择"},n||{}),e.data(t,i,o),this._init(t)},_newInst:function(e){var t=e[0].id.replace(/([^A-Za-z0-9_])/g,"\\\\$1");return{id:t}},_getInst:function(t){try{return e.data(t,i)}catch(n){throw"Missing instance data for this completed"}},_destroyCompleted:function(){},_init:function(t){var i=this._getInst(t),n=i.id,o=i.settings;this._buildHTML(n,o),e(document).click(function(t){t.target.id!==n&&e("#"+n+"SelectedPanel").hide()}),o.onlySelect||this._buildCheckboxPanel(n,o.data)},_buildHTML:function(t,i){var n=i.height+"px",o=this._getDefaults(e.completed._defaults,i,"styleClass"),a=e("#"+t),l="";i.onlySelect||(l+="<button onclick=\"$('#"+t+"CheckboxPanel').toggle()\">"+i.buttonText+"</button>"),l+="<div id='"+t+"SelectedPanel' class='"+o.panelClass+"' style='height:"+n+";'></div><div class='none "+o.ckClass+"' id='"+t+"CheckboxPanel'><div>","object"==typeof i.data&&i.data.sort(),a.after(l).bind("keyup",{settings:i},this._keyupAction).bind("keydown",function(e){i.chinese=e.keyCode}).addClass(o.inputClass).width(a.width()-78);var s=e("#"+t+"SelectedPanel");i.tipNum=0,s.width(a.width()+2)},_keyupAction:function(t){var i=t.data.settings,n=e.completed._getCurrentWord(this,i);if(""===n.currentWord||27===t.keyCode||16===t.keyCode||16===t.keyCode)return e("#"+this.id+"SelectedPanel").hide(),i.tipNum=0,void(i.afterKeyup?i.afterKeyup(t):"");var o=e.completed._getMatchData(i.data,this.value,n.currentWord);if(38===t.keyCode&&(i.tipNum>0?i.tipNum--:i.tipNum=o.length-1),40===t.keyCode&&(i.tipNum<o.length-1?i.tipNum++:i.tipNum=0),e.completed._buildSelectedPanel(this.id,o,i,n.currentWord),13===t.keyCode&&o[i.tipNum]&&229!==i.chinese){var a=this.value;this.value=a.substring(0,n.startPos)+o[i.tipNum]+a.substring(n.endPos,a.length),e("#"+this.id+"SelectedPanel").hide(),i.chinese=void 0}38!==t.keyCode&&40!==t.keyCode&&(i.tipNum=0),i.afterKeyup?i.afterKeyup(t):""},_getCurrentWord:function(t,i){var n=e(t).val(),o=!0,a=0,l=0,s=e.completed._defaults.separator;if(""===n)return{currentWord:"",startPos:l,endPos:a};if(document.selection)try{var d=document.selection.createRange(),r=t.createTextRange();r.collapse(!0),r.select();var c=document.selection.createRange();c.setEndPoint("EndToEnd",d),i.curPos=c.text.length,d.select()}catch(u){delete u}else i.curPos=t.selectionStart;for(var h=i.curPos,g=0;g<n.length;g++)n.charAt(g)===s&&g>=h&&o&&(a=g,o=!1);o===!0&&(o=!1,a=n.length);for(var p=a;p>-1;p--)n.charAt(p)===s&&h>p&&!o&&(l=p+1,o=!0);return{currentWord:n.substring(l,a),startPos:l,endPos:a}},_getMatchData:function(t,i,n){for(var o=i.split(e.completed._defaults.separator),a=[],l=0;l<t.length;l++)if("number"==typeof t[l]&&(t[l]=t[l].toString()),t[l].toLowerCase().indexOf(n.toLowerCase())>-1){for(var s=!0,d=0;d<o.length;d++)t[l]===o[d].toString()&&t[l].toLowerCase()!==n.toLowerCase()&&(s=!1);s&&a.push(t[l])}return a},_mousemoveSelectPanel:function(t,i,n){e(t).parent().find("a").removeClass("selected"),t.className="selected";var o=e.completed._getInst(document.getElementById(n));o.settings.tipNum=i},_buildSelectedPanel:function(t,i,n,o){var a=e("#"+t+"SelectedPanel");if(0===i.length)return void a.html("").hide();n.tipNum>=i.length&&(n.tipNum=0);for(var l="",s=0;s<i.length;s++){var d="",r=i[s].replace(o,"<b>"+o+"</b>");n.tipNum===s&&(d="class='selected'"),l+="<a href='javascript:void(0);'                                         onmousemove=\"$.completed._mousemoveSelectPanel(this, "+s+", '"+t+"');\"                                        "+d+">"+r+"</a>"}a.html(l).show();var c=e("#"+t+"SelectedPanel a.selected");c.position().top+a.scrollTop()>50-c.height()&&a.scrollTop(c.position().top+a.scrollTop()+c.height()-50),c.position().top<0&&a.scrollTop(a.scrollTop-c.height()),e("#"+t+"SelectedPanel a").click(function(){var i=document.getElementById(t),o=e.completed._getCurrentWord(document.getElementById(t),n),a=e.completed._getMatchData(n.data,i.value,o.currentWord),l=i.value;i.value=l.substring(0,o.startPos)+a[n.tipNum]+l.substring(o.endPos,l.length),n.tipNum=0,e(i).focus(),n.afterSelected?n.afterSelected(e(this)):""})},_buildCheckboxPanel:function(t,i){for(var n="",o=e("#"+t),a=0;a<i.length;a++)n+="<span>"+i[a]+"</span>";e("#"+t+"CheckboxPanel").html(n+"<div class='clear'></div>"),e("#"+t+"CheckboxPanel span").click(function(){var e=o.val(),t=this.innerHTML;if("selected"===this.className){this.className="";var i=e.substr(e.indexOf(t)+t.length,1);t===e||","!==i?o.val(e.replace(t,"")):o.val(e.replace(t+",",""))}else this.className="selected",""===e.replace(/\s/g,"")||","===e.substr(e.length-1,1)?o.val(e+t):o.val(e+","+t)}),this._matchChecked(t),o.blur(function(){e.completed._matchChecked(t)})},_matchChecked:function(t){var i=e("#"+t).val().split(",");e("#"+t+"CheckboxPanel span").removeClass().each(function(){for(var e=0;e<i.length;e++)this.innerHTML===i[e]&&(this.className="selected")})},_updateDataCompleted:function(t,i,n){var o=this._getInst(t),a=o.id,l=o.settings;l.data=n,e.completed._buildSelectedPanel(a,n,l,"2011")},_getDefaults:function(e,t,i){if("styleClass"===i){if("default"===t.theme||void 0===t.theme)return e.styleClass;t.styleClass={};for(var n in e[i])t.styleClass[n]=t.theme+"-"+e.styleClass[n]}else{if("height"===i||"width"===i)return null===t[i]||void 0===t[i]?"auto":t[i]+"px";if(null===t[i]||void 0===t[i])return e[i]}return t[i]}}),e.fn.completed=function(t){var i=Array.prototype.slice.call(arguments);return this.each(function(){"string"==typeof t?e.completed["_"+t+"Completed"].apply(e.completed,[this].concat(i)):e.completed._attach(this,t)})},e.completed=new n,window["DP_jQuery_"+t]=e}(jQuery);
jQuery.notification=function(e,i){var o=function(){if(i.Notification&&(i.Notification.permissionLevel||i.Notification.permission))return i.Notification;var o=i.webkitNotifications;if(!o)return function(){var i={};return i.permission="unsupported",i.permissionLevel=function(){return"unsupported"},i.requestPermission=e.noop,i}();var n=["granted","default","denied"],r=function(i,n){if(n=n||{},i){var t=o.createNotification(n.iconUrl||"",i,n.body||"");return t.titleDir=n.titleDir||"auto",t.body=n.body||"",t.bodyDir=n.bodyDir||"auto",t.tag=n.tag||"",t.replaceId=n.tag||"",t.iconUrl=n.iconUrl||"",t.onclick=n.onclick||e.noop,t.onshow=n.onshow||e.noop,t.onerror=n.onerror||e.noop,t.onclose=n.onclose||e.noop,t.close=function(){t.cancel()},"granted"===r.permissionLevel()&&t.show(),t}};return r.permissionLevel=function(){return r.permission=n[o.checkPermission()]},r.permissionLevel(),r.requestPermission=function(e){if("default"!==r.permissionLevel())return void e();if(o.requestPermission.length)return void o.requestPermission(function(){r.permissionLevel(),e()});o.requestPermission();var n=i.setInterval(function(){var o=r.permissionLevel();"default"!==o&&(i.clearInterval(n),e())},200)},r}(),n=function(i){return"default"!==(o.permission||o.permissionLevel())?void i():void e(document).one("click",function(){o.requestPermission(i)})},r=function(i){var r=e.Deferred();if(!o.prototype)return r.reject("unsupported"),r.promise();"string"==typeof i&&(i={title:i}),i=i||{},i.autoclose="undefined"==typeof i.autoclose?!0:i.autoclose,i.timeout=i.timeout||1/0;var t=i.iconUrl||i.icon;return t&&(i.icon=t),n(function(){var e=o.permission||o.permissionLevel();if("granted"!==e)return void r.reject(e);var n=new o(i.title,i);isFinite(i.timeout)&&n.addEventListener("show",function(){setTimeout(function(){n.close()},i.timeout)},!1),i.autoclose&&n.addEventListener("click",function(){n.close()},!1),r.resolve(n)}),r.promise()};return r.permission=o.permission,r.permissionLevel=o.permissionLevel||function(){return o.permission},r.requestPermission=n,r}(jQuery,window);
