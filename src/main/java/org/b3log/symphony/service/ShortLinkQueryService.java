...
public class ShortLinkQueryService {
     ...
     * Id pattern.
     */
    private static final Pattern ID_PATTERN = Pattern.compile(" \\[\\d{13,15}\\] ");

    /**
     * Tag title pattern.
     */
    private static final Pattern TAG_TITLE_PATTERN = Pattern.compile(" \\[[\\u4e00-\\u9fa5,\\w,\\s,&,\\+,\\-,\\.]+\\](?!\\(.+\\)) ");
