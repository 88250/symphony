                                                ...
                                                <table>
                                                    ...
                                                    <tbody><tr style="border-collapse:collapse">
                                                            ...
                                                            <td style="border-collapse:collapse;font-family:Helvetica,Arial,sans-serif;font-size:13px;line-height:20px;padding:0 0 15px 10px">
                                                                <a href="https://segmentfault.com/q/1010000006878324?utm_source=weekly&amp;utm_medium=email&amp;utm_campaign=email_weekly" style="color:#595959;font-weight:bold;text-decoration:none;font-size:14px" target="_blank"><strong>用C语言socket登入斗鱼弹幕服务器的问题</strong></a>
                                                                <br>
                                                                <span style="color:#999;">根据斗鱼给的开发者手册，用struct构建出应用层协议头，<wbr>发送登入请求，建立连接成功但没有从服务器传回...</span>
                                                            </td>
                                                        </tr>
